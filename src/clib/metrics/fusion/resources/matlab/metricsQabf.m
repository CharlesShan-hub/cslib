...
function Qabf1= Qabf(strA, strB, strF)
    ...
    %disp(mean(strA,'all'));disp(mean(strB,'all'));disp(mean(strF,'all'));
    %disp(mean(SAx,'all'));disp(mean(SAy,'all'));
    %disp(mean(SBx,'all'));disp(mean(SBy,'all'));
    %disp(mean(SFx,'all'));disp(mean(SFy,'all'));
    %disp(mean(gA,'all'));disp(mean(aA,'all'));
    %disp(mean(gB,'all'));disp(mean(aB,'all'));
    %disp(mean(gF,'all'));disp(mean(aF,'all'));
    ...
    disp(mean(GAF,'all'));disp(mean(AAF,'all'));
    disp(mean(GBF,'all'));disp(mean(ABF,'all'));
