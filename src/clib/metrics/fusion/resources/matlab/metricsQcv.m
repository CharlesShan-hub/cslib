...
%     Df1=ifft2(ifftshift(fftshift(ff1).*theta_d));
%     Df2=ifft2(ifftshift(fftshift(ff2).*theta_d));
    Df1=ifft2(ifftshift(fftshift(ff1).*theta_a));
    Df2=ifft2(ifftshift(fftshift(ff2).*theta_a));
